...
IPTables4Start() {
    ...
    $IPT_M -A TUN_MANGLE_PRE -m set --match-set $IPSetName_DirectV4 dst -j RETURN
    $IPT_M -A TUN_MANGLE_PRE -m set --match-set $IPSetName_ProxyV4 dst -p tcp -j MARK --set-mark 0x1
    $IPT_M -A TUN_MANGLE_PRE -m set --match-set $IPSetName_ProxyV4 dst -p udp -j MARK --set-mark 0x1
    $IPT_M -A TUN_MANGLE_PRE -m set ! --match-set $IPSetName_CNV4 dst -p tcp -j MARK --set-mark 0x1
    $IPT_M -A TUN_MANGLE_PRE -m set ! --match-set $IPSetName_CNV4 dst -p udp -j MARK --set-mark 0x1
    ...
    $IPT_M -A TUN_MANGLE_OUT -m set --match-set $IPSetName_DirectV4 dst -j RETURN
    $IPT_M -A TUN_MANGLE_OUT -m set --match-set $IPSetName_ProxyV4 dst -p tcp -j MARK --set-mark 0x1
    $IPT_M -A TUN_MANGLE_OUT -m set --match-set $IPSetName_ProxyV4 dst -p udp -j MARK --set-mark 0x1
    $IPT_M -A TUN_MANGLE_OUT -m set ! --match-set $IPSetName_CNV4 dst -p tcp -j MARK --set-mark 0x1
    $IPT_M -A TUN_MANGLE_OUT -m set ! --match-set $IPSetName_CNV4 dst -p udp -j MARK --set-mark 0x1
...
IPTables6Start() {
    ...
    $IP6T_M -A TUN_MANGLE_PRE -m set --match-set $IPSetName_DirectV6 dst -j RETURN
    $IP6T_M -A TUN_MANGLE_PRE -m set --match-set $IPSetName_ProxyV6 dst -p tcp -j MARK --set-mark 0x1
    $IP6T_M -A TUN_MANGLE_PRE -m set --match-set $IPSetName_ProxyV6 dst -p udp -j MARK --set-mark 0x1
    $IP6T_M -A TUN_MANGLE_PRE -m set ! --match-set $IPSetName_CNV6 dst -p tcp -j MARK --set-mark 0x1
    $IP6T_M -A TUN_MANGLE_PRE -m set ! --match-set $IPSetName_CNV6 dst -p udp -j MARK --set-mark 0x1
    ...
    $IP6T_M -A TUN_MANGLE_OUT -m set --match-set $IPSetName_DirectV6 dst -j RETURN
    $IP6T_M -A TUN_MANGLE_OUT -m set --match-set $IPSetName_ProxyV6 dst -p tcp -j MARK --set-mark 0x1
    $IP6T_M -A TUN_MANGLE_OUT -m set --match-set $IPSetName_ProxyV6 dst -p udp -j MARK --set-mark 0x1
    $IP6T_M -A TUN_MANGLE_OUT -m set ! --match-set $IPSetName_CNV6 dst -p tcp -j MARK --set-mark 0x1
    $IP6T_M -A TUN_MANGLE_OUT -m set ! --match-set $IPSetName_CNV6 dst -p udp -j MARK --set-mark 0x1
